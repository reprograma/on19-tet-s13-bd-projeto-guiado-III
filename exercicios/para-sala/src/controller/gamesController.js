...
const addNewGame = async (req, res) => {
    try {
        ...
        const findConsole = await gamesModel.findById(consoleId);
...
const updateGame = async (req, res) => {
    try {
        ...
        findGame.releaseDate = releaseData || findGame.releaseDate;
...
const deleteGame = async (req, res) => {
  ...
  const findGameByAvailable = async (req, res) => {
    try {
        ...
        const findGameByAvailable = await gamesModel.find(name);
        const message = `Achou esse Jogo ${findGameByAvailable.name}`;
